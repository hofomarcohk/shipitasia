...
// P17 — `pending_client_label` is retained only for legacy rows; new
// outbounds never enter that state because the warehouse auto-fetches the
// label. The label_obtaining / label_obtained states are warehouse-driven
// progress indicators (read-only for the customer).
const STATUS_GROUPS = {
  active: [
    "held",
    "ready_for_label",
                ...
                <thead>
                  <tr className="text-left border-b bg-gray-50">
                    ...
                    <th className="py-3 px-3">
                      {t("outbound_v1.list.shipment_type")}
                    </th>
                    <th className="py-3 px-3 text-right">
                      {t("outbound_v1.list.inbound_count")}
                    </th>
                    <th className="py-3 px-3">
                      {t("outbound_v1.list.carrier")}
                    </th>
                    <th className="py-3 px-3">
                      {t("outbound_v1.list.country")}
                    </th>
                    <th className="py-3 px-3 text-right">
                    ...
                    <th className="py-3 px-3">
                      {t("outbound_v1.list.tracking_no")}
                    </th>
                    <th className="py-3 px-3">
                      {t("outbound_v1.list.created_at")}
                    </th>
                  </tr>
                </thead>
                <tbody>
