...
import { clientConfirmLabel } from "@/services/outbound/wmsFlow";
...
export async function POST(
  ...
  return cmsMiddleware(request, null, async (): Promise<ApiReturn> => {
    ...
    const data = await clientConfirmLabel(client_id, outboundId);
    return { status: 200, message: "Label fetch triggered", data };
  });
}
